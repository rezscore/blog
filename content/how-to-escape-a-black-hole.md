...
date: 2019-05-15
author: "RezScore"
tags: [job-search, resume-tips, rezscore-jobs]
description: "Why submitting your resume online so often feels like throwing it into a black hole, and how RezScore Jobs solves the job-search black hole."
image: https://miro.medium.com/v2/resize:fit:1100/1*BhMyphiISdHqLVw49t8yXg.jpeg
medium_slug: how-to-escape-a-black-hole-1e93b4cf18e7
draft: false
---

In 2019, scientists first photographed a black hole. Although scientists thought black holes were elusive, job searchers know that black holes are in fact quite common, appearing every time you submit your resume on a job board.
...
Now that [RezScore Jobs](https://jobs.rezscore.com/) exists, there's no reason to ever worry about the Job Search Black Hole. We've solved the problem by guaranteeing that your resume never disappears into a black hole.

We solved the Job Search Black Hole by building our job board with the following features:

1. **Giving you a receipt for every application.** Most job sites don't do this because they expect your resume to go nowhere. RezScore had the sharp idea to keep track of your application so you could actually know what happened to it. As soon as you send out your application, we send you an email confirmation.
...
3. **Providing actionable feedback on your application.** In many cases we can provide actionable feedback on why your application was rejected. This means you can actually get useful feedback on how to improve your application in the future. Getting any feedback makes rejections a lot more productive, as you can more quickly iterate your way to a job.
...
You may worry that a job site that offers so much to the job seeker would not have any jobs. Fortunately, we have one of the largest and most actively updated databases, by both sourcing directly and scraping from across the internet. We have listings for most every major company and position, just [check it out](https://jobs.rezscore.com/) and see.

Escaping the black hole is easier than the physicists ever imagined. Start your next application at [RezScore Jobs](https://jobs.rezscore.com/) and never wonder where your resume went again.
