...
image: /static/blog/images/what-is-a-good-resume-score/social-card-v2.png
image_alt: "Resume score guide illustrated with a balanced gauge and evidence checklist"
image_width: 1200
image_height: 630
draft: false
---
...
Here is the real distribution. RezScore has graded more than 13 million resumes lifetime; the numbers below come from the modern corpus, more than 70,000 resumes graded in the current system since November 2020.
...
An A puts you in the top 17 percent of everyone who has run a resume through the grader. An A or a B puts you in the top 47 percent. The median resume, the one right in the middle of the pack, is a C. If your resume comes back a C, you are not failing. You are exactly average, which is worth knowing plainly rather than being told a comforting story about it.

We covered the full distribution and what separates the letter grades in more depth in [our data study of what separates an A resume from an F](/what-separates-an-a-resume-from-an-f/), including the corpus size and methodology behind these numbers.
...
The fastest way to answer "is my score good" is to get an actual score against the actual distribution above, not guess. [Grade your resume free](https://ai.rezscore.com/), no signup required, and see exactly where you fall against more than 70,000 other graded resumes.
