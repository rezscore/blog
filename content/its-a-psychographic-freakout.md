...
date: 2016-05-11
author: "RezScore"
tags: [personality, hiring, data, resume-tips]
description: "RezScore's four-dimensional personality model for resumes, a more workplace-relevant alternative to Myers-Briggs."
image: https://miro.medium.com/v2/resize:fit:1100/1*BhMyphiISdHqLVw49t8yXg.jpeg
medium_slug: its-a-psychographic-freakout-ae219a43f55c
draft: false
---

RezScore has analyzed millions of resumes, and many clusters of personality traits have emerged. We have been tracking and refining these for some time, and we're proud to present them to the public.
...
As to how you can use these scores in your job hunt, it's a bit more nuanced. No right answer exists in a vacuum, but if you are applying for a leadership position you should make sure you are more "officer" than "soldier". Similarly, presenting yourself as an extrovert may not make a difference for a technical position, but is crucial for customer support roles.
...
* What jobs need which personality traits?
