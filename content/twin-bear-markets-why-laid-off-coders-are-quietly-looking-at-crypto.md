...
date: 2026-06-16
author: "Gerrit Hall"
tags: [crypto, jobs, web3, computer-science]
description: "Tech's job market and crypto's price chart are both in the dirt at the same time. That coincidence is doing something interesting to where talent goes."
image: /static/blog/charts/c3_crypto_split_screen.png
medium_slug: twin-bear-markets-why-laid-off-coders-are-quietly-looking-at-crypto-617b00f88531
draft: false
---
...
**Every figure below is sourced and dated. [Full methodology and citations here →](https://github.com/rezscore/crypto-hiring-analysis)**
...
![Crypto prices vs all-time highs](/static/blog/charts/c2_crypto_drawdown.png)
...
Stablecoins - dollar-pegged tokens, the boring plumbing of the industry - reached an **all-time-high market cap of $317 billion in March 2026**, per [CoinDesk Research](https://www.coindesk.com/research/stablecoins-and-tokenized-asset-report-january-2026), a second consecutive monthly record. Tokenization of real-world assets, long dismissed as a slide-deck fantasy, became real: tokenized U.S. Treasuries stood at **about $14.7 billion as of June 4, 2026** ([rwa.xyz](https://app.rwa.xyz/treasuries)), and the broader tokenized-asset market crossed **$30 billion**, holding around **$34 billion** through early 2026. The names doing it are not degens: JPMorgan, Franklin Templeton, Fidelity, UBS, Apollo.

Venture money tells the same story. Crypto VC is well off its mania-era peak of **roughly $30 billion a year in 2021-2022** ([Galaxy Research](https://www.galaxy.com/insights/research/crypto-blockchain-vc-venture-capital-startups-fundraising-q1-2026)). But "off the peak" is not "gone": funding ran about **$11.5 billion in 2024**, recovered to **nearly $20 billion in 2025**, and Q1 2026 saw **about $4 billion across 355 deals** - a pace that annualizes near **$16 billion**. (Trackers differ on the exact totals depending on what they count; we use Galaxy's figures throughout for consistency.)
...
It also tracks with what the industry is actually talking about day to day. Of the most-discussed topics on the crypto-news platform [Leviathan News](https://leviathannews.xyz/) over the past week (per its [trending-topics data](https://api.leviathannews.xyz/api/v1/intel/trending/?hours=168&top_n=25), as of June 4, 2026), the leaders weren't meme-coins - they were **Stablecoins, Markets, Institutional Adoption, Real-World Assets, Infrastructure, and Payments**. The conversation has moved to building, even while the price chart bleeds.

![Crypto's split screen: prices down, institutional money up](/static/blog/charts/c3_crypto_split_screen.png)
...
![More code, flat developer base](/static/blog/charts/c4_code_vs_coders.png)
...
*RezScore has graded over 13 million resumes since 2014. Every statistic in this post comes from a named, dated public source - listed below. Where a claim couldn't be verified, we dropped it rather than guess. [Full methodology and citations →](https://github.com/rezscore/crypto-hiring-analysis)*

### Sources

- **Crypto funding** - [Galaxy Research](https://www.galaxy.com/research)
- **Developer counts** - [Electric Capital Developer Report](https://www.developerreport.com/)
- **Crypto prices & sentiment** - [Pantera Capital](https://panteracapital.com/), [CoinDesk](https://www.coindesk.com/), [rwa.xyz](https://app.rwa.xyz/), and the [Crypto Fear & Greed Index](https://alternative.me/crypto/fear-and-greed-index/)
- **Tokenization / institutional adoption** - [a16z crypto](https://a16zcrypto.com/), [CoinDesk Research](https://www.coindesk.com/research/)
- **Labor market** - [layoffs.fyi](https://layoffs.fyi/), the [Stanford Digital Economy Lab](https://digitaleconomy.stanford.edu/), and the [Computing Research Association](https://cra.org/)
